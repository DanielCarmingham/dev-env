...
load_config() {
    ...
    export DEV_ENV_PORTS_BASEHTTPS DEV_ENV_PORTS_BASEHTTP DEV_ENV_PORTS_BASEVITE DEV_ENV_PORTS_BASEDEBUG
    ...
    export DEV_ENV_BASE_DEBUG="${DEV_ENV_PORTS_BASEDEBUG}"
